...
This repository contains academic publications exploring stateful AI systems that maintain persistent identity, behavioral continuity, and dispositional scaffolding across sessions. The work addresses architectural amnesia in current LLM-based systems and proposes continuity frameworks for human-centric AI development.

**Principal Investigator:** Tionne Smith  
**Organization:** Antiparty Inc.  
**ORCID:** [0009-0008-8627-6150](https://orcid.org/0009-0008-8627-6150)
...
Introduces the Logic-over-Model (LOM) substrate, a host-native layer that decouples identity governance from probabilistic inference. Benchmarks demonstrate 0.007ms warm-path mean latency and 100% integrity in deterministic vetoes, proving that structured governance can be mathematically free.

[Full Text](papers/2026/PresenceEngine_Deterministic_Identity_TSmith_19101284.pdf)
...
[Full Text](./papers/2025/StatefulReasoningRuntimes_ArchitecturalPatterns_IdentityPersistence_TSmith.pdf)
...
*"The impact of AI on humanity may have less to do with the way we use it than how it is built. Presence Engine offers a way of favoring continuity and coherence over present shock and calibration."*  
— Douglas Rushkoff, Author of *Team Human*

[Full Text](./papers/2025/PresenceEngine_TSmithThesisv3.pdf)
...
[Full Text](./papers/2025/Human-CentricAIXStack_PresenceEngine_C³Model_TSmith_V2.pdf)
...
[Full Text](./papers/2025/Domain-CalibratedTrustStatefulAISystems_TSmith.pdf)
...
[Full Text](./papers/2025/AgentGoalDrift_StatefulSystems_TSmith.pdf)
...
[Full Text](./papers/2025/Dignity-First_ArtificialIntelligence_Privacy-Ethics-HumanAgency_TSmith.pdf)
...
[Full Text](./papers/2025/WhyStatefulAIFailsWithoutEthicalGuardrails_TSmith_antipartypress.pdf)
...
[Full Text](./papers/2025/StatefulIntelligence_Human-AIExperiences_PresenceEngine.pdf)
...
[Full Text](./papers/2025/Anthropic_TechBrief_TSmith.pdf)

---

## Benchmarks

14 validated benchmarks demonstrating 100% pass rate with sub-millisecond stateful execution:
...
*Benchmark documentation coming soon in `/benchmarks` directory*

---

## Academic Validation

- **Dr. Michael Hogan** (University of Galway) - Dispositional scaffolding framework
- **Douglas Rushkoff** (Author, *Team Human*) - Cultural and philosophical validation

---

## Industry Partnerships

- **Anthropic** - 4.5M API credits for A/B testing pilot (Claude Haiku 4.5)
- **ElevenLabs** - 300K credits for voice synthesis research
...
**Duration:** 120 days  
**Objective:** Measure developmental outcomes vs. displacement in stateful AI systems
...
```bibtex
@thesis{smith2025presence,
  title={Presence Engine™ Living Thesis: Building Human-Centric AIX™ (AI Experience)},
  author={Smith, Tionne},
  year={2025},
...
**Tionne Smith**  
Founder & CEO, Antiparty Inc.  
Email: smith@antiparty.co  
LinkedIn: [linkedin.com/in/saytionne](https://linkedin.com/in/saytionne)  
ORCID: [0009-0008-8627-6150](https://orcid.org/0009-0008-8627-6150)
...
All publications are Open Access under Creative Commons licensing as specified in individual DOI records.

---

## Community

Join the [Stateful AI community on Zenodo](https://zenodo.org/communities/stateful-ai) for updates on new research and collaborations.
